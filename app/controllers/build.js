...
var getOne = function(req, res) {
    build.getBuild(req.account, req.params.buildID, function(err, build) {
        respond(err, build, res);
    });
};

var update = function(req, res) {
    build.updateBuild(req.account, req.params.buildID, req.body, function(err, build) {
        respond(err, build, res);
    });
};

var destroy = function(req, res) {
    build.destroyBuild(req.account, req.params.buildID, function(err, build) {
        respond(err, build, res);
    });
};
