...
var getOne = function(req ,res) {
    account.getAccount(req.params.accountID, function(err, account) {
        respond(err, account, res);
    });
};

var update = function(req, res) {
    account.updateAccount(req.params.accountID, req.body, function(err, account) {
        respond(err, account, res);
    });
};

var destroy = function(req, res) {
    account.deleteAccount(req.params.accountID, function(err, account) {
        respond(err, account, res);
    });
};
